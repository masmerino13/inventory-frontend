										...
										<div className="border d-flex p-2 rounded-5 mb-2">
											...
											<div className="my-auto ms-auto">
												<nav className="contact-info d-flex">
													<Link to="#" className="contact-icon border tx-inverse rounded-pill" ><i className="fe fe-phone tx-12"></i></Link>
													<Link to="#" className="contact-icon border tx-inverse rounded-pill" ><i className="fe fe-video tx-12"></i></Link>
												</nav>
											</div>
										</div>
									</div>
