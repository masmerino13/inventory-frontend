...
import userImage from '../../../../../src/assets/img/users/1.jpg';
import userImage1 from '../../../../../src/assets/img/users/2.jpg';
                  ...
                  <Col xl={3} className="animated fadeIn p-4 demo-app">
                    ...
                    <div className="mt-5">
                      ...
                      <Card className="border p-0 pt-3">
                        ...
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={userImage} alt="avatar-img" />
                      ...
                      <Card className="border p-0 pt-3">
                        ...
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={userImage1} alt="avatar-img" />
                            <div className="media-body valign-middle">
