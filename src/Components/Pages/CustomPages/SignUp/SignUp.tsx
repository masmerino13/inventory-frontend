...
import Signup from '../../../../assets/img/pngs/8.png';
					...
					<Col md={6} lg={6} xl={7} className="d-none d-md-flex bg-primary-transparent">
						<Row className="wd-100p mx-auto text-center">
							<Col md={12} lg={12} xl={12} className="my-auto mx-auto wd-100p">
								<img src={Signup} className="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo" />
							</Col>
						</Row>
					</Col>
										...
										<div className="card-sigin">
											...
											<div className="main-signup-header">
												...
												<Form action="#">
													...
													<Link className="btn btn-main-primary btn-block" to={`${import.meta.env.BASE_URL}indexpage`}>Create Account</Link>
