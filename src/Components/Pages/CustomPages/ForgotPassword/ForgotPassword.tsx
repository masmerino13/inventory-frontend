...
import Forgot from '../../../../assets/img/pngs/3.png';
					...
					<Col md={6} lg={6} xl={7} className="d-none d-md-flex bg-primary-transparent">
						<Row className="wd-100p mx-auto text-center">
							<Col md={12} lg={12} xl={12} className="my-auto mx-auto wd-100p">
								<img src={Forgot} className="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo" />
							</Col>
						</Row>
					</Col>
											...
											<div className="wd-100p">
												<div className="main-signin-header">
													...
													<Form action="#">
														...
														<Button className="btn-main-primary btn-block" onClick={forgetLink}>Send</Button>
													</Form>
												</div>
